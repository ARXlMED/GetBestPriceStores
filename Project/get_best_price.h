...
int partition(Product& product, std::vector<double>& values, int left, int right, std::vector<std::string>& all_name_stores, std::vector<int>& all_coef_stores, map<std::string, double>* massive_cities = nullptr);